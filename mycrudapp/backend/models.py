...
class PostField(models.Model):
    ...
    post_id = models.UUIDField(default=uuid.uuid4, editable=False, unique=True) #you can do (primary_key=True) if you dont want to use "id"
                                                                                # instead u post_id see 191 on views.py
